...
const Card: React.FC<CardProps> = (props) => {
    ...
    <div className="overflow-x-hidden rounded-2xl relative">
      ...
      <p className="absolute right-2 top-2 bg-white rounded-full p-2 cursor-pointer group hover:bg-blue-600 hover:text-white" onClick={onCartClick}>
    ...
    <div className="mt-4 pl-2 mb-2 flex justify-between ">
      ...
      <div className="flex flex-col-reverse mb-1 mr-4 group cursor-pointer">
        {isLike ? <FillHeartIcon className="h-5 w-5 text-red-600" onClick={onLikeClick}/> : <HeartIcon className="h-5 w-5 hover:text-red-600" onClick={onLikeClick}/>}
      </div>
    </div>
  </div>);
}
